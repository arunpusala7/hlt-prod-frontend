        ...
        <main className="user-main-container" style={styles.mainContainer}>
          {!isTenantActive && (
            <motion.div
              ...
              style={styles.networkPausedBanner}
            >
              <div style={styles.networkPausedIcon}>⚠️</div>
              <div style={{ flex: 1 }}>
                <h4 style={styles.networkPausedTitle}>
                  Service Notice: Online Bookings Temporarily Paused
                </h4>
                <p style={styles.networkPausedDesc}>
                  Consultation bookings and slot reservations for <strong>{tenant?.name || "this healthcare network"}</strong> are currently paused. All your past appointments, QR passes, prescriptions, and payment receipts remain safe and viewable in your dashboard.
                </p>
              </div>
            </motion.div>
          )}
