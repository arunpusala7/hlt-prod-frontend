...
import { isEntityActive } from "../utils/statusUtils";
...
export function TenantProvider({ children }) {
  ...
  const isTenantActive = isEntityActive(tenant);

  return (
    <TenantContext.Provider value={{ tenant, setTenant, loadingTenant, isTenantActive }}>
      {children}
